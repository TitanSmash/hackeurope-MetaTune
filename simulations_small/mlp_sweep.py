...
def grid_sweep() -> List[Dict[str, Any]]:
    """Grid search over all combinations of hyperparameters."""
    epochs_opts = [10, 15, 20, 30]
    batch_size_opts = [256, 512, 1024, 2048]
    lr_opts = [1e-4, 5e-4, 1e-3, 5e-3]
    weight_decay_opts = [1e-7, 1e-5, 1e-3]
    hidden_dim_opts = [32, 64, 128, 256]
    n_layers_opts = [1, 2, 3, 4, 5]
    dropout_opts = [0.0, 0.05, 0.1, 0.2]
    grad_clip_opts = [0.0, 0.5, 1.0, 2.0]
